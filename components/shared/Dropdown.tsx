...
const Dropdown = ({value, onChangeHandler}: DropdownProps) => {
    ...
    <Select onValueChange={onChangeHandler} defaultValue={value} >
        ...
        <SelectContent>
            ...
            <AlertDialog>
                <AlertDialogTrigger className='p-medium-14 flex w-full round-sm py-3 pl-8 text-primary-500 hover:bg-primary-50 focus:text-primary-500'>Adicionar Categoria</AlertDialogTrigger>
